...
export const useProducts = () => {
    ...
    useEffect(() => {
        ...
        setSearchParams({
            ...
            priceFrom: router.query.priceFrom as undefined && parseInt(router.query.priceFrom as string),
            priceTo: router.query.priceFrom as undefined && parseInt(router.query.priceTo as string),
